...
ARG ELIXIR_VERSION=1.20.0-rc.2
...
# advised to add an init process such as tini via `apt-get install -y tini` and
# to set the entrypoint to be `ENTRYPOINT ["/usr/bin/tini", "--"]`
CMD ["/app/bin/server"]
