defmodule ParchmentStudios.Application do
  ...
  def start(_type, _args) do
    children = [
      ParchmentStudiosWeb.Telemetry,
      ParchmentStudios.Repo,
      {Ecto.Migrator,
    ...
    opts = [strategy: :one_for_one, name: ParchmentStudios.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ParchmentStudiosWeb.Endpoint.config_change(changed, removed)
    :ok
  end
